...
import { FaFacebookF, FaPinterestP, FaYoutube, FaInstagram, FaLinkedinIn } from "react-icons/fa";
import { FaXTwitter } from "react-icons/fa6"; // or use a different icon if this fails
...
function App() {
  ...
  <nav className="container mx-auto px-4 py-6 flex justify-between items-center">
    <div className="flex items-center">
      <img src='../public/GenScriptAI 500Px.png'  alt="GenScript AI Logo" 
    ...
    <div className="flex items-center gap-4">
      ...
      <button className="bg-[#1A1F35] text-white px-6 py-2 rounded-lg hover:bg-[#252B45] transition-colors">
        Sign Up
      </button>
    </div>
  </nav>
  ...
  <section className="mt-32 container mx-auto px-4 pb-32 relative z-10">
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-16 items-center justify-items-center">
      ...
      <img src='../public/elevenlabs.png'  alt="GenScript AI Logo" 
      className="w-10 h-10"></img>
      ...
      <img src='../public/aws.png'  alt="AWS Startup" 
      className="w-10 h-10"></img>
      <span className="text-2xl ">
        AWS Startups
      </span>
      ...
      <div className="flex items-center gap-1">
        <img src='../public/microsoft.png' alt="Microsoft Startup" className="w-10 h-10" />
        <span className="text-2xl">Microsoft for Startups</span>
      </div>
      <div className="flex items-center gap-2">
        <img src='../public/nvidia.png' alt="NVIDIA" className="w-10 h-10" />
        <span className="text-2xl">NVIDIA Inception Program</span>
      </div>
    </div>
 ...
 <section className="mt-32 container mx-auto px-4 pb-32 relative z-10">
        ...
        <img src='../public/cia triad.png' alt="CIA Triad" 
 ...
 <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
   {/* Article 1 */}
   <div className="bg-[#0A0F25] rounded-3xl p-8 flex flex-col h-full">
     ...
     <div className="flex justify-between items-center mt-auto">
       ...
       <button className="bg-[#4169E1] text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition-colors">
         Learn More
       </button>
     </div>
   </div>
 ...
 <footer className="bg-[#0C0C24] text-white px-6 lg:px-20 py-10 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center border-b border-gray-700 pb-6">
          <div className="flex items-center gap-4">
            <img src="../public/GenScriptAI 500Px.png" alt="Logo" className="h-8" />
            <span className="text-xl font-bold">GENSCRIPT AI</span>
            <div className="hidden lg:block border-l border-gray-600 h-6 mx-4" />
            <span className="text-gray-300 text-sm hidden lg:block">Solutions that drive content's success</span>
          </div>
        ...
        <div className="mt-6 text-sm text-gray-300">
          Contact Us – <a href="mailto:marketing@genscriptai.com" className="text-white font-medium">marketing@genscriptai.com</a>
        </div>
        ...
        <div className="mt-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          <div className="text-gray-400 text-sm leading-relaxed">
            ...
            <p>We are recognized by Startup India with DIPP180145 (Media & Entertainment industry).</p>
          </div>
